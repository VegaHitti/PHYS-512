...
#The only difference between this file and the file from question 3 is in the function "prior_pdf()"
...
#The fit parameters from question 2, but I changed tau to 0.054

fit_pars = np.asarray([6.84955561e+01,2.24189493e-02,1.16905708e-01,0.054,1.89729855e-09,9.72141191e-01])
...
def prior_pdf(pars, fit_pars = fit_pars, fit_errs = par_errs):
    ...
    #Adding constraints to tau
    tau_llim = 0.054 - 0.0074
    tau_ulim = 0.054 + 0.0074
